...
STOPWORDS={"a","al","con","cómo","como","de","del","el","en","es","esta","está","este","la","las","lo","los","me","mi","para","por","qué","que","se","su","un","una","y","yo","hola","buenas","saludos","estás","estas","hablar","quiero","sobre","gracias","adiós","adios","chao","significa","relaciona","relacionar","relación","relacion","qué","es"}
